"""
Django settings for sqwe_38589 project.
...
WSGI_APPLICATION = 'sqwe_38589.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sqwe_38589 API",
    "DESCRIPTION": "API documentation for sqwe_38589 App",
    "VERSION": "v1",
}
